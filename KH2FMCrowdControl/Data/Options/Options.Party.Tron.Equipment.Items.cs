        ...
        public async Task<List<ButtonTemplate>> InitializeTronItemsOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost500, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Tron's Item Slots to 0", ImageUrl = "", MethodName = "SendTronItemSlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost250, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Tron's Item Slots to 1", ImageUrl = "Shared/Items/Item1.png", MethodName = "SendTronItemSlotsMessage"  },
                        new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Tron's Item Slots to 2", ImageUrl = "Shared/Items/Item2.png", MethodName = "SendTronItemSlotsMessage"  },
                    }
                },
                new ButtonTemplate
                {
