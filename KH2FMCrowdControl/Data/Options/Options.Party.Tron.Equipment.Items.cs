...
namespace KH2FMCrowdControl.Data
{
    ...
    {
        public async Task<List<ButtonTemplate>> InitializeTronItemsOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    Cost = 0,
                    Description = "Update Tron's Item Slots",
                    ImageUrl = "Items/Megalixir.png",
                    SubMethodParams = new List<ButtonTemplate>
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost500, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Tron's Item Slots to 0", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendTronItemSlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost250, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Tron's Item Slots to 1", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendTronItemSlotsMessage"  },
                        new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Tron's Item Slots to 2", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendTronItemSlotsMessage"  },
                    }
                },
                new ButtonTemplate
                {
                    ...
                    SubCategory = SubGroupType.Tron,
                    Cost = 0,
                    Description = "Update Tron's Item Slot 1",
                    ImageUrl = "Items/Megalixir.png",
                ...
                new ButtonTemplate
                {
                    ...
                    SubCategory = SubGroupType.Tron,
                    Cost = 0,
                    Description = "Update Tron's Item Slot 2",
                    ImageUrl = "Items/Megalixir.png",
                    SubMethodParams = items.CreateListFromList()
                }
            };

            options.FirstOrDefault(x => x.Name.Equals("Change Item Slot 1")).SubMethodParams.ForEach(x => x.MethodName = "SendTronItemSlot1Message");
            options.FirstOrDefault(x => x.Name.Equals("Change Item Slot 2")).SubMethodParams.ForEach(x => x.MethodName = "SendTronItemSlot2Message");
