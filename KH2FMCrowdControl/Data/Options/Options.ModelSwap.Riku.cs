...
namespace KH2FMCrowdControl.Data
{
    ...
    {
        public async Task<List<ButtonTemplate>> InitializeRikuModelSwapOptions()
        {
            ...
            {                
                ...
                new ButtonTemplate { Name = "Randomize", Cost = Constants.Cost750, Value = "RandomAlly", ManipulationType = ManipulationType.Set, Description = "Switch Model to a Random one on room change", ImageUrl = "Characters/Riku.png" },
            ...
            {                
                new ButtonTemplate { Name = "Randomize", Cost = Constants.Cost750, Value = "RandomEnemy", ManipulationType = ManipulationType.Set, Description = "Switch Model to a Random one on room change", ImageUrl = "Characters/Riku.png" },
