...
namespace KH2FMCrowdControl.Data
{
    public partial class Options
    {
        public async Task<List<ButtonTemplate>> InitializeModelSwapOptions()
        {
            ...
            {
                new ButtonTemplate { Name = "Randomize", Cost = Constants.Cost750, Value = "RandomAlly", ManipulationType = ManipulationType.Set, Description = "Switch Model to a Random one on room change", ImageUrl = "Characters/Aladdin.png" },
            ...
            {
                new ButtonTemplate { Name = "Randomize", Cost = Constants.Cost750, Value = "RandomEnemy", ManipulationType = ManipulationType.Set, Description = "Switch Model to a Random one on room change", ImageUrl = "Characters/Aladdin.png" },
            ...
            options.AddRange(await this.InitializeDonaldModelSwapOptions(ally.CreateListFromList(), enemy.CreateListFromList()));
            options.AddRange(await this.InitializeGoofyModelSwapOptions(ally.CreateListFromList(), enemy.CreateListFromList()));

            options.AddRange(await this.InitializeMulanModelSwapOptions(ally.CreateListFromList(), enemy.CreateListFromList()));
            options.AddRange(await this.InitializeBeastModelSwapOptions(ally.CreateListFromList(), enemy.CreateListFromList()));
            options.AddRange(await this.InitializeAuronModelSwapOptions(ally.CreateListFromList(), enemy.CreateListFromList()));
            options.AddRange(await this.InitializeCaptainJackSparrowModelSwapOptions(ally.CreateListFromList(), enemy.CreateListFromList()));
            options.AddRange(await this.InitializeAladdinModelSwapOptions(ally.CreateListFromList(), enemy.CreateListFromList()));
            options.AddRange(await this.InitializeJackSkellingtonModelSwapOptions(ally.CreateListFromList(), enemy.CreateListFromList()));
            options.AddRange(await this.InitializeSimbaModelSwapOptions(ally.CreateListFromList(), enemy.CreateListFromList()));
