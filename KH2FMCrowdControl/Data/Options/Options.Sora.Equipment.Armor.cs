...
namespace KH2FMCrowdControl.Data
{
    ...
    {
        public async Task<List<ButtonTemplate>> InitializeSoraArmorOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost2000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Sora's Armor Slots to 0", ImageUrl = "", MethodName = "SendSoraArmorSlotsMessage" },
                ...
                new ButtonTemplate
                {
                    ...
                    ImageUrl = "Shared/Armor/Armor3.png",
                    SubMethodParams = armor.CreateListFromList()
                },
                new ButtonTemplate
                {
                    ...
                    ImageUrl = "Shared/Armor/Armor4.png",
                    SubMethodParams = armor.CreateListFromList()
                }
            };

            options.FirstOrDefault(x => x.Name.Equals("Change Armor Slot 1")).SubMethodParams.ForEach(x => x.MethodName = "SendSoraArmorSlot1Message");
            options.FirstOrDefault(x => x.Name.Equals("Change Armor Slot 2")).SubMethodParams.ForEach(x => x.MethodName = "SendSoraArmorSlot2Message");
            options.FirstOrDefault(x => x.Name.Equals("Change Armor Slot 3")).SubMethodParams.ForEach(x => x.MethodName = "SendSoraArmorSlot3Message");
            options.FirstOrDefault(x => x.Name.Equals("Change Armor Slot 4")).SubMethodParams.ForEach(x => x.MethodName = "SendSoraArmorSlot4Message");
