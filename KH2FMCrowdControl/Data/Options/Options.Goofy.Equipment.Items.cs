            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    SubMethodParams = new List<ButtonTemplate>
                    {
                        ...
                        new ButtonTemplate { Name = "2 Slot", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Item Slots to 2", ImageUrl = "Items/Potion.png", MethodName = "SendGoofyItemSlotsMessage" },
                        new ButtonTemplate { Name = "3 Slot", Cost = Constants.Cost300, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Item Slots to 1", ImageUrl = "Items/Potion.png", MethodName = "SendGoofyItemSlotsMessage" },
                        new ButtonTemplate { Name = "4 Slot", Cost = Constants.Cost400, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Item Slots to 2", ImageUrl = "Items/Potion.png", MethodName = "SendGoofyItemSlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
