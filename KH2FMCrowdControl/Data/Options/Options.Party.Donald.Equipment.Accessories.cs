...
namespace KH2FMCrowdControl.Data
{
    ...
    {
        public async Task<List<ButtonTemplate>> InitializeDonaldAccessoriesOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost1000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Donald's Accessory Slots to 0", ImageUrl = "", MethodName = "SendDonaldAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost300, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Donald's Accessory Slots to 1", ImageUrl = "Shared/Accessories/ACC1.png", MethodName = "SendDonaldAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost250, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Donald's Accessory Slots to 2", ImageUrl = "Shared/Accessories/ACC2.png", MethodName = "SendDonaldAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "3 Slots", Cost = Constants.Cost400, Value = 3, ManipulationType = ManipulationType.Set, Description = "Set Donald's Accessory Slots to 3", ImageUrl = "Shared/Accessories/ACC3.png", MethodName = "SendDonaldAccessorySlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
            ...
            options.FirstOrDefault(x => x.Name.Equals("Change Accessory Slot 1")).SubMethodParams.ForEach(x => x.MethodName = "SendDonaldAccessorySlot1Message");
            options.FirstOrDefault(x => x.Name.Equals("Change Accessory Slot 2")).SubMethodParams.ForEach(x => x.MethodName = "SendDonaldAccessorySlot2Message");
            options.FirstOrDefault(x => x.Name.Equals("Change Accessory Slot 3")).SubMethodParams.ForEach(x => x.MethodName = "SendDonaldAccessorySlot3Message");
