...
namespace KH2FMCrowdControl.Data
{
    ...
    {
        public async Task<List<ButtonTemplate>> InitializeSoraAccessoriesOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost2000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Sora's Accessory Slots to 0", ImageUrl = "", MethodName = "SendSoraAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost300, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Sora's Accessory Slots to 1", ImageUrl = "Shared/Accessories/ACC1.png", MethodName = "SendSoraAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost250, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Sora's Accessory Slots to 2", ImageUrl = "Shared/Accessories/ACC2.png", MethodName = "SendSoraAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "3 Slots", Cost = Constants.Cost300, Value = 3, ManipulationType = ManipulationType.Set, Description = "Set Sora's Accessory Slots to 3", ImageUrl = "Shared/Accessories/ACC3.png", MethodName = "SendSoraAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "4 Slots", Cost = Constants.Cost400, Value = 4, ManipulationType = ManipulationType.Set, Description = "Set Sora's Accessory Slots to 4", ImageUrl = "Shared/Accessories/ACC4.png", MethodName = "SendSoraAccessorySlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
                ...
                new ButtonTemplate
                {
                    ...
                    ImageUrl = "Shared/Accessories/ACC2.png",
                    SubMethodParams = accessories.CreateListFromList()
                },
                new ButtonTemplate
                {
                    ...
                    ImageUrl = "Shared/Accessories/ACC3.png",
                    SubMethodParams = accessories.CreateListFromList()
                },
                new ButtonTemplate
                {
                    ...
                    ImageUrl = "Shared/Accessories/ACC4.png",
                    SubMethodParams = accessories.CreateListFromList()
                },
            };

            options.FirstOrDefault(x => x.Name.Equals("Change Accessory Slot 1")).SubMethodParams.ForEach(x => x.MethodName = "SendSoraAccessorySlot1Message");
            options.FirstOrDefault(x => x.Name.Equals("Change Accessory Slot 2")).SubMethodParams.ForEach(x => x.MethodName = "SendSoraAccessorySlot2Message");
            options.FirstOrDefault(x => x.Name.Equals("Change Accessory Slot 3")).SubMethodParams.ForEach(x => x.MethodName = "SendSoraAccessorySlot3Message");
            options.FirstOrDefault(x => x.Name.Equals("Change Accessory Slot 4")).SubMethodParams.ForEach(x => x.MethodName = "SendSoraAccessorySlot4Message");
