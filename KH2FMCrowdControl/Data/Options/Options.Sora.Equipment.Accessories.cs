            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    SubMethodParams = new List<ButtonTemplate>
                    {
                        ...
                        new ButtonTemplate { Name = "2 Slot", Cost = Constants.Cost250, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Sora's Armor Slots to 2", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendSoraAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "3 Slot", Cost = Constants.Cost300, Value = 3, ManipulationType = ManipulationType.Set, Description = "Set Sora's Armor Slots to 3", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendSoraAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "4 Slot", Cost = Constants.Cost400, Value = 4, ManipulationType = ManipulationType.Set, Description = "Set Sora's Armor Slots to 4", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendSoraAccessorySlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
