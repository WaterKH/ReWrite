        ...
        public async Task<List<ButtonTemplate>> InitializeGoofyAccessoriesOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost1000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Accessory Slots to 0", ImageUrl = "", MethodName = "SendGoofyAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost300, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Accessory Slots to 1", ImageUrl = "Shared/Accessories/ACC1.png", MethodName = "SendGoofyAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost250, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Accessory Slots to 2", ImageUrl = "Shared/Accessories/ACC2.png", MethodName = "SendGoofyAccessorySlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
