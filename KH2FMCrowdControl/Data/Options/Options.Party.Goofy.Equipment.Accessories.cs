            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    SubMethodParams = new List<ButtonTemplate>
                    {
                        ...
                        new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost250, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Armor Slots to 2", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendGoofyAccessorySlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
