...
namespace KH2FMCrowdControl.Data
{
    ...
    {
        public async Task<List<ButtonTemplate>> InitializeTronArmorOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    Cost = 0,
                    Description = "Update Tron's Armor Slots",
                    ImageUrl = "Armor/Abas_Chain.png",
                    SubMethodParams = new List<ButtonTemplate>
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost1000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Tron's Armor Slots to 0", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendTronArmorSlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost250, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Tron's Armor Slots to 1", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendTronArmorSlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
            ...
            options.FirstOrDefault(x => x.Name.Equals("Change Armor Slot 1")).SubMethodParams.ForEach(x => x.MethodName = "SendTronArmorSlot1Message");
