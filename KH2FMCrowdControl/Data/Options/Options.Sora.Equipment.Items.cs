            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    SubMethodParams = new List<ButtonTemplate>
                    {
                        ...
                        new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost300, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Sora's Item Slots to 2", ImageUrl = "Items/Potion.png", MethodName = "SendSoraItemSlotsMessage" },
                        new ButtonTemplate { Name = "3 Slots", Cost = Constants.Cost250, Value = 3, ManipulationType = ManipulationType.Set, Description = "Set Sora's Item Slots to 3", ImageUrl = "Items/Potion.png", MethodName = "SendSoraItemSlotsMessage" },
                        new ButtonTemplate { Name = "4 Slots", Cost = Constants.Cost200, Value = 4, ManipulationType = ManipulationType.Set, Description = "Set Sora's Item Slots to 4", ImageUrl = "Items/Potion.png", MethodName = "SendSoraItemSlotsMessage" },
                        new ButtonTemplate { Name = "5 Slots", Cost = Constants.Cost250, Value = 5, ManipulationType = ManipulationType.Set, Description = "Set Sora's Item Slots to 5", ImageUrl = "Items/Potion.png", MethodName = "SendSoraItemSlotsMessage" },
                        new ButtonTemplate { Name = "6 Slots", Cost = Constants.Cost300, Value = 6, ManipulationType = ManipulationType.Set, Description = "Set Sora's Item Slots to 6", ImageUrl = "Items/Potion.png", MethodName = "SendSoraItemSlotsMessage" },
                        new ButtonTemplate { Name = "7 Slots", Cost = Constants.Cost400, Value = 7, ManipulationType = ManipulationType.Set, Description = "Set Sora's Item Slots to 7", ImageUrl = "Items/Potion.png", MethodName = "SendSoraItemSlotsMessage" },
                        new ButtonTemplate { Name = "8 Slots", Cost = Constants.Cost500, Value = 8, ManipulationType = ManipulationType.Set, Description = "Set Sora's Item Slots to 8", ImageUrl = "Items/Potion.png", MethodName = "SendSoraItemSlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
