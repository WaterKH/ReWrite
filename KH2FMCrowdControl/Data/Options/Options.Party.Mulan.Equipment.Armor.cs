        ...
        public async Task<List<ButtonTemplate>> InitializeMulanArmorOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost1000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Mulan's Armor Slots to 0", ImageUrl = "", MethodName = "SendMulanArmorSlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost250, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Mulan's Armor Slots to 1", ImageUrl = "Shared/Armor/Armor1.png", MethodName = "SendMulanArmorSlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
