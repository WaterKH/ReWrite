...
namespace KH2FMCrowdControl.Data
{
    ...
    {
        public async Task<List<ButtonTemplate>> InitializeRikuArmorOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    Cost = 0,
                    Description = "Update Riku's Armor Slots",
                    ImageUrl = "Armor/Abas_Chain.png",
                    SubMethodParams = new List<ButtonTemplate>
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost1000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Riku's Armor Slots to 0", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendRikuArmorSlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost250, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Riku's Armor Slots to 1", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendRikuArmorSlotsMessage" },
                        new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Riku's Armor Slots to 2", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendRikuArmorSlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
                ...
                new ButtonTemplate
                {
                    ...
                    SubCategory = SubGroupType.Riku,
                    Cost = 0,
                    Description = "Update Riku's Armor Slot 2",
                    ImageUrl = "Armor/Abas_Chain.png",
                    SubMethodParams = armor.CreateListFromList()
                }
            };

            options.FirstOrDefault(x => x.Name.Equals("Change Armor Slot 1")).SubMethodParams.ForEach(x => x.MethodName = "SendRikuArmorSlot1Message");
            options.FirstOrDefault(x => x.Name.Equals("Change Armor Slot 2")).SubMethodParams.ForEach(x => x.MethodName = "SendRikuArmorSlot2Message");
