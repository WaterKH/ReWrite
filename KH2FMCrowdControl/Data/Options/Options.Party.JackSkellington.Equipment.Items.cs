        ...
        public async Task<List<ButtonTemplate>> InitializeJackSkellingtonItemsOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost500, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set JackSkellington's Item Slots to 0", ImageUrl = "", MethodName = "SendJackSkellingtonItemSlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost250, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set JackSkellington's Item Slots to 1", ImageUrl = "Shared/Items/Item1.png", MethodName = "SendJackSkellingtonItemSlotsMessage"  },
                        new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set JackSkellington's Item Slots to 2", ImageUrl = "Shared/Items/Item2.png", MethodName = "SendJackSkellingtonItemSlotsMessage"  },
                        new ButtonTemplate { Name = "3 Slots", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set JackSkellington's Item Slots to 3", ImageUrl = "Shared/Items/Item3.png", MethodName = "SendJackSkellingtonItemSlotsMessage"  },
                    }
                },
                new ButtonTemplate
                {
