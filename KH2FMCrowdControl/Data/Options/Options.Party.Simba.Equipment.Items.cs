...
namespace KH2FMCrowdControl.Data
{
    ...
    {
        public async Task<List<ButtonTemplate>> InitializeSimbaItemsOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    Cost = 0,
                    Description = "Update Simba's Item Slots",
                    ImageUrl = "Items/Megalixir.png",
                    SubMethodParams = new List<ButtonTemplate>
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost500, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Simba's Item Slots to 0", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendSimbaItemSlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost250, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Simba's Item Slots to 1", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendSimbaItemSlotsMessage"  },
                        new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Simba's Item Slots to 2", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendSimbaItemSlotsMessage"  },
                        new ButtonTemplate { Name = "3 Slots", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Simba's Item Slots to 2", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendSimbaItemSlotsMessage"  },
                    }
                },
                new ButtonTemplate
                {
                    ...
                    SubCategory = SubGroupType.Simba,
                    Cost = 0,
                    Description = "Update Simba's Item Slot 1",
                    ImageUrl = "Items/Megalixir.png",
                ...
                new ButtonTemplate
                {
                    ...
                    SubCategory = SubGroupType.Simba,
                    Cost = 0,
                    Description = "Update Simba's Item Slot 2",
                    ImageUrl = "Items/Megalixir.png",
                    SubMethodParams = items.CreateListFromList()
                },
                new ButtonTemplate
                {
                    ...
                    SubCategory = SubGroupType.Simba,
                    Cost = 0,
                    Description = "Update Simba's Item Slot 3",
                    ImageUrl = "Items/Megalixir.png",
                    SubMethodParams = items.CreateListFromList()
                }
            };

            options.FirstOrDefault(x => x.Name.Equals("Change Item Slot 1")).SubMethodParams.ForEach(x => x.MethodName = "SendSimbaItemSlot1Message");
            options.FirstOrDefault(x => x.Name.Equals("Change Item Slot 2")).SubMethodParams.ForEach(x => x.MethodName = "SendSimbaItemSlot2Message");
            options.FirstOrDefault(x => x.Name.Equals("Change Item Slot 3")).SubMethodParams.ForEach(x => x.MethodName = "SendSimbaItemSlot3Message");
