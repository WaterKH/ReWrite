...
namespace KH2FMCrowdControl.Data
{
    ...
    {
        public async Task<List<ButtonTemplate>> InitializeJackSkellingtonAccessoriesOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    Cost = 0,
                    Description = "Update Number of Jack Skellington's Accessory Slots",
                    ImageUrl = "Shared/Accessories/ACC.png",
                    SubMethodParams = new List<ButtonTemplate>
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost1000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set JackSkellington's Accessory Slots to 0", ImageUrl = "", MethodName = "SendJackSkellingtonAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost300, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set JackSkellington's Accessory Slots to 1", ImageUrl = "Shared/Accessories/ACC1.png", MethodName = "SendJackSkellingtonAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost250, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set JackSkellington's Accessory Slots to 2", ImageUrl = "Shared/Accessories/ACC2.png", MethodName = "SendJackSkellingtonAccessorySlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
                    ...
                    SubCategory = SubGroupType.JackSkellington,
                    Cost = 0,
                    Description = "Update Jack Skellington's Accessory Slot 1",
                ...
                new ButtonTemplate
                {
                    ...
                    SubCategory = SubGroupType.JackSkellington,
                    Cost = 0,
                    Description = "Update Jack Skellington's Accessory Slot 2",
                    ImageUrl = "Shared/Accessories/ACC2.png",
                    SubMethodParams = accessories.CreateListFromList()
                }
            };

            options.FirstOrDefault(x => x.Name.Equals("Change Accessory Slot 1")).SubMethodParams.ForEach(x => x.MethodName = "SendJackSkellingtonAccessorySlot1Message");
            options.FirstOrDefault(x => x.Name.Equals("Change Accessory Slot 2")).SubMethodParams.ForEach(x => x.MethodName = "SendJackSkellingtonAccessorySlot2Message");
