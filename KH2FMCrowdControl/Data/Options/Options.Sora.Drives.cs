            ...
            var options = new List<ButtonTemplate>() {
                ...
                new ButtonTemplate
                {
                    ...
                    SubMethodParams = new List<ButtonTemplate>
                    {
                        ...
                        new ButtonTemplate { Name = Constants.ValorForm, Cost = Constants.Cost400, Value = 0x0226, ManipulationType = ManipulationType.Set, Description = "Activate Valor Form", ImageUrl = "Sora/Drive/FormValor.png", MethodName = "SendActivateFormMessage" },
                        new ButtonTemplate { Name = Constants.WisdomForm, Cost = Constants.Cost400, Value = 0x0227, ManipulationType = ManipulationType.Set, Description = "Activate Wisdom Form", ImageUrl = "Sora/Drive/FormWisdom.png", MethodName = "SendActivateFormMessage" },
                        new ButtonTemplate { Name = Constants.LimitForm, Cost = Constants.Cost500, Value = 0x02A2, ManipulationType = ManipulationType.Set, Description = "Activate Limit Form", ImageUrl = "Sora/Drive/FormLimit.png", MethodName = "SendActivateFormMessage" },
                        new ButtonTemplate { Name = Constants.MasterForm, Cost = Constants.Cost500, Value = 0x0228, ManipulationType = ManipulationType.Set, Description = "Activate Master Form", ImageUrl = "Sora/Drive/FormMaster.png", MethodName = "SendActivateFormMessage" },
                        new ButtonTemplate { Name = Constants.FinalForm, Cost = Constants.Cost750, Value = 0x0229, ManipulationType = ManipulationType.Set, Description = "Activate Final Form", ImageUrl = "Sora/Drive/FormFinal.png", MethodName = "SendActivateFormMessage" },
