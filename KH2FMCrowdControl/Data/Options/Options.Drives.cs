            ...
            var options = new List<KHButtonTemplate>() {
                ...
                new KHButtonTemplate
                {
                    ...
                    SubMethodParams = new List<KHButtonTemplate>
                    {
                        ...
                        new KHButtonTemplate { Name = Constants.ValorForm, Cost = Constants.Cost400, Value = 6, ManipulationType = ManipulationType.Set, Description = "Activate Valor Form", ImageUrl = "Drives/Valor_Form_Orb.png", Method = EventCallback.Factory.Create<MemoryParameters>(this, this.messageHubMessages.SendActivateFormMessage) },
                        new KHButtonTemplate { Name = Constants.WisdomForm, Cost = Constants.Cost400, Value = 7, ManipulationType = ManipulationType.Set, Description = "Activate Wisdom Form", ImageUrl = "Drives/Wisdom_Form_Orb.png", Method = EventCallback.Factory.Create<MemoryParameters>(this, this.messageHubMessages.SendActivateFormMessage) },
                        new KHButtonTemplate { Name = Constants.LimitForm, Cost = Constants.Cost500, Value = 673, ManipulationType = ManipulationType.Set, Description = "Activate Limit Form", ImageUrl = "Drives/Limit_Form_Orb.png", Method = EventCallback.Factory.Create<MemoryParameters>(this, this.messageHubMessages.SendActivateFormMessage) },
                        new KHButtonTemplate { Name = Constants.MasterForm, Cost = Constants.Cost500, Value = 11, ManipulationType = ManipulationType.Set, Description = "Activate Master Form", ImageUrl = "Drives/Master_Form_Orb.png", Method = EventCallback.Factory.Create<MemoryParameters>(this, this.messageHubMessages.SendActivateFormMessage) },
                        new KHButtonTemplate { Name = Constants.FinalForm, Cost = Constants.Cost750, Value = 12, ManipulationType = ManipulationType.Set, Description = "Activate Final Form", ImageUrl = "Drives/Final_Form_Orb.png", Method = EventCallback.Factory.Create<MemoryParameters>(this, this.messageHubMessages.SendActivateFormMessage) },
                        new KHButtonTemplate { Name = Constants.Antiform, Cost = Constants.Cost1000, Value = 13, ManipulationType = ManipulationType.Set, Description = "Activate Antiform", ImageUrl = "Drives/Anti_Form_Orb.png", Method = EventCallback.Factory.Create<MemoryParameters>(this, this.messageHubMessages.SendActivateFormMessage) },
