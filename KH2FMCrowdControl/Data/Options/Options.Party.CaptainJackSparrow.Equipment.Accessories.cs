...
namespace KH2FMCrowdControl.Data
{
    ...
    {
        public async Task<List<ButtonTemplate>> InitializeCaptainJackSparrowAccessoriesOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    Cost = 0,
                    Description = "Update Number of Captain Jack Sparrow's Accessory Slots",
                    ImageUrl = "Accessories/Cosmic_Ring.png",
                    SubMethodParams = new List<ButtonTemplate>
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost1000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set CaptainJackSparrow's Armor Slots to 0", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendCaptainJackSparrowAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost300, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set CaptainJackSparrow's Armor Slots to 1", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendCaptainJackSparrowAccessorySlotsMessage" },    
                    }
                },
                new ButtonTemplate
                {
                    ...
                    SubCategory = SubGroupType.CaptainJackSparrow,
                    Cost = 0,
                    Description = "Update Captain Jack Sparrow's Accessory Slot 1",
                    ImageUrl = "Accessories/Cosmic_Ring.png",
                    SubMethodParams = accessories.CreateListFromList()
                },
            };

            options.FirstOrDefault(x => x.Name.Equals("Change Accessory Slot 1")).SubMethodParams.ForEach(x => x.MethodName = "SendCaptainJackSparrowAccessorySlot1Message");
