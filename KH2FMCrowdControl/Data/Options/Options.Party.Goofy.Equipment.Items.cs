            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    SubMethodParams = new List<ButtonTemplate>
                    {
                        ...
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost250, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Item Slots to 1", ImageUrl = "Shared/Items/Item1.png", MethodName = "SendGoofyItemSlotsMessage" },
                        new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Item Slots to 2", ImageUrl = "Shared/Items/Item2.png", MethodName = "SendGoofyItemSlotsMessage" },
                        new ButtonTemplate { Name = "3 Slots", Cost = Constants.Cost300, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Item Slots to 1", ImageUrl = "Shared/Items/Item3.png", MethodName = "SendGoofyItemSlotsMessage" },
                        new ButtonTemplate { Name = "4 Slots", Cost = Constants.Cost400, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Item Slots to 2", ImageUrl = "Shared/Items/Item4.png", MethodName = "SendGoofyItemSlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
