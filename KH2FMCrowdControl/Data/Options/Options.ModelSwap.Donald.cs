        ...
        public async Task<List<ButtonTemplate>> InitializeDonaldModelSwapOptions()
        {
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    SubMethodParams = new List<ButtonTemplate>
                    {
                        new ButtonTemplate { Name = Constants.Donald, Cost = Constants.Cost500, Value = 0x5B, ManipulationType = ManipulationType.Set, Description = "Revert Donald to KH2 Model", ImageUrl = "Characters/Donald.png" },
