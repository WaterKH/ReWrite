        ...
        public async Task<List<ButtonTemplate>> InitializeMulanAccessoriesOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost1000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Mulan's Accessory Slots to 0", ImageUrl = "", MethodName = "SendMulanAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost300, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Mulan's Accessory Slots to 1", ImageUrl = "Shared/Accessories/ACC1.png", MethodName = "SendMulanAccessorySlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
