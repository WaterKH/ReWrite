...
namespace KH2FMCrowdControl.Data
{
    ...
    {
        public async Task<List<ButtonTemplate>> InitializeMulanAccessoriesOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    Cost = 0,
                    Description = "Update Number of Mulan's Accessory Slots",
                    ImageUrl = "Accessories/Cosmic_Ring.png",
                    SubMethodParams = new List<ButtonTemplate>
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost1000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Mulan's Armor Slots to 0", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendMulanAccessorySlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost300, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Mulan's Armor Slots to 1", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendMulanAccessorySlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
                    ...
                    SubCategory = SubGroupType.Mulan,
                    Cost = 0,
                    Description = "Update Mulan's Accessory Slot 1",
                    ImageUrl = "Accessories/Cosmic_Ring.png",
                    SubMethodParams = accessories.CreateListFromList()
                }
            };

            options.FirstOrDefault(x => x.Name.Equals("Change Accessory Slot 1")).SubMethodParams.ForEach(x => x.MethodName = "SendMulanAccessorySlot1Message");
