                    ...
                    SubMethodParams = new List<ButtonTemplate>
                        {
                            ...
                            new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Armor Slots to 2", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendGoofyArmorSlotsMessage" },
                            new ButtonTemplate { Name = "3 Slots", Cost = Constants.Cost300, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Armor Slots to 3", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendGoofyArmorSlotsMessage" },
                        }
                },
                new ButtonTemplate
                {
