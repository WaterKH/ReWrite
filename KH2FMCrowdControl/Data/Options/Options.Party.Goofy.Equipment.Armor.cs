            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    SubMethodParams = new List<ButtonTemplate>
                        {
                            new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost1000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Armor Slots to 0", ImageUrl = "", MethodName = "SendGoofyArmorSlotsMessage" },
                            new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost250, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Armor Slots to 1", ImageUrl = "Shared/Armor/Armor1.png", MethodName = "SendGoofyArmorSlotsMessage" },
                            new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Armor Slots to 2", ImageUrl = "Shared/Armor/Armor2.png", MethodName = "SendGoofyArmorSlotsMessage" },
                            new ButtonTemplate { Name = "3 Slots", Cost = Constants.Cost300, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Goofy's Armor Slots to 3", ImageUrl = "Shared/Armor/Armor3.png", MethodName = "SendGoofyArmorSlotsMessage" },
                        }
                },
                new ButtonTemplate
                {
