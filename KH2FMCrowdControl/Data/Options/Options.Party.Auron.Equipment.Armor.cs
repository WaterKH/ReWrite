        ...
        public async Task<List<ButtonTemplate>> InitializeAuronArmorOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost1000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Auron's Armor Slots to 0", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendAuronArmorSlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost250, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Auron's Armor Slots to 1", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendAuronArmorSlotsMessage" },    
                    }
                },
                new ButtonTemplate
                {
