...
namespace KH2FMCrowdControl.Data
{
    ...
    {
        public async Task<List<KHButtonTemplate>> InitializeDonaldAccessoriesOptions()
        {
            ...
            var options = new List<KHButtonTemplate> {
                ...
                new KHButtonTemplate
                {
                    ...
                    Cost = 0,
                    Description = "Update Number of Donald's Accessory Slots",
                    ImageUrl = "Accessories/Cosmic_Ring.png",
                    SubMethodParams = new List<KHButtonTemplate>
                    {
                        new KHButtonTemplate { Name = "No Slots", Cost = Constants.Cost1000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Donald's Armor Slots to 0", ImageUrl = "Armor/Abas_Chain.png", Method = EventCallback.Factory.Create<MemoryParameters>(this, this.messageHubMessages.SendDonaldAccessorySlotsMessage) },
                        new KHButtonTemplate { Name = "1 Slot", Cost = Constants.Cost300, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Donald's Armor Slots to 1", ImageUrl = "Armor/Abas_Chain.png", Method = EventCallback.Factory.Create<MemoryParameters>(this, this.messageHubMessages.SendDonaldAccessorySlotsMessage) },
                        new KHButtonTemplate { Name = "2 Slot", Cost = Constants.Cost250, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Donald's Armor Slots to 2", ImageUrl = "Armor/Abas_Chain.png", Method = EventCallback.Factory.Create<MemoryParameters>(this, this.messageHubMessages.SendDonaldAccessorySlotsMessage) },
                        new KHButtonTemplate { Name = "3 Slot", Cost = Constants.Cost400, Value = 3, ManipulationType = ManipulationType.Set, Description = "Set Donald's Armor Slots to 3", ImageUrl = "Armor/Abas_Chain.png", Method = EventCallback.Factory.Create<MemoryParameters>(this, this.messageHubMessages.SendDonaldAccessorySlotsMessage) },
                    }
                },
                new KHButtonTemplate
                {
                    ...
                    Category = GroupType.Donald,
                    Cost = 0,
                    Description = "Update Donald's Accessory Slot 1",
                    ImageUrl = "Accessories/Cosmic_Ring.png",
                ...
                new KHButtonTemplate
                {
                    ...
                    Category = GroupType.Donald,
                    Cost = 0,
                    Description = "Update Donald's Accessory Slot 2",
                    ImageUrl = "Accessories/Cosmic_Ring.png",
                    SubMethodParams = accessories.CreateListFromList()
                },
                new KHButtonTemplate
                {
                    ...
                    Category = GroupType.Donald,
                    Cost = 0,
                    Description = "Update Donald's Accessory Slot 3",
                    ImageUrl = "Accessories/Cosmic_Ring.png",
                    SubMethodParams = accessories.CreateListFromList()
                }
            };
            
            options.FirstOrDefault(x => x.Name.Equals("Change Accessory Slot 1")).SubMethodParams.ForEach(x => x.Method = EventCallback.Factory.Create<MemoryParameters>(this, this.messageHubMessages.SendDonaldAccessorySlot1Message));
            options.FirstOrDefault(x => x.Name.Equals("Change Accessory Slot 2")).SubMethodParams.ForEach(x => x.Method = EventCallback.Factory.Create<MemoryParameters>(this, this.messageHubMessages.SendDonaldAccessorySlot2Message));
            options.FirstOrDefault(x => x.Name.Equals("Change Accessory Slot 3")).SubMethodParams.ForEach(x => x.Method = EventCallback.Factory.Create<MemoryParameters>(this, this.messageHubMessages.SendDonaldAccessorySlot3Message));
