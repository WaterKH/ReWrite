        ...
        public async Task<List<ButtonTemplate>> InitializeAladdinArmorOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost1000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Aladdin's Armor Slots to 0", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendAladdinArmorSlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost250, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Aladdin's Armor Slots to 1", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendAladdinArmorSlotsMessage" },
                        new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Aladdin's Armor Slots to 2", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendAladdinArmorSlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
