...
namespace KH2FMCrowdControl.Data
{
    ...
    {
        public async Task<List<ButtonTemplate>> InitializeAladdinArmorOptions()
        {
            var armor = new List<ButtonTemplate>
            {
                new ButtonTemplate { Name = Constants.None, Cost = Constants.Cost750, Value = 0, ManipulationType = ManipulationType.Set, Description = "Give Elven Bandana", ImageUrl = "" },
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    Cost = 0,
                    Description = "Update Aladdin's Armor Slots",
                    ImageUrl = "Shared/Armor/Armor.png",
                    SubMethodParams = new List<ButtonTemplate>
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost1000, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set Aladdin's Armor Slots to 0", ImageUrl = "", MethodName = "SendAladdinArmorSlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost250, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set Aladdin's Armor Slots to 1", ImageUrl = "Shared/Armor1.png", MethodName = "SendAladdinArmorSlotsMessage" },
                        new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set Aladdin's Armor Slots to 2", ImageUrl = "Shared/Armor2.png", MethodName = "SendAladdinArmorSlotsMessage" },
                    }
                },
                new ButtonTemplate
                {
                ...
                new ButtonTemplate
                {
                    ...
                    SubCategory = SubGroupType.Aladdin,
                    Cost = 0,
                    Description = "Update Aladdin's Armor Slot 2",
                    ImageUrl = "Shared/Armor/Armor2.png",
                    SubMethodParams = armor.CreateListFromList()
                }
            };

            options.FirstOrDefault(x => x.Name.Equals("Change Armor Slot 1")).SubMethodParams.ForEach(x => x.MethodName = "SendAladdinArmorSlot1Message");
            options.FirstOrDefault(x => x.Name.Equals("Change Armor Slot 2")).SubMethodParams.ForEach(x => x.MethodName = "SendAladdinArmorSlot2Message");
