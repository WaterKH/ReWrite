        ...
        public async Task<List<ButtonTemplate>> InitializeCaptainJackSparrowItemsOptions()
        {
            ...
            var options = new List<ButtonTemplate> {
                ...
                new ButtonTemplate
                {
                    ...
                    {
                        new ButtonTemplate { Name = "No Slots", Cost = Constants.Cost500, Value = 0, ManipulationType = ManipulationType.Set, Description = "Set CaptainJackSparrow's Item Slots to 0", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendCaptainJackSparrowItemSlotsMessage" },
                        new ButtonTemplate { Name = "1 Slot", Cost = Constants.Cost250, Value = 1, ManipulationType = ManipulationType.Set, Description = "Set CaptainJackSparrow's Item Slots to 1", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendCaptainJackSparrowItemSlotsMessage"  },
                        new ButtonTemplate { Name = "2 Slots", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set CaptainJackSparrow's Item Slots to 2", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendCaptainJackSparrowItemSlotsMessage"  },
                        new ButtonTemplate { Name = "3 Slots", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set CaptainJackSparrow's Item Slots to 3", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendCaptainJackSparrowItemSlotsMessage"  },
                        new ButtonTemplate { Name = "4 Slots", Cost = Constants.Cost200, Value = 2, ManipulationType = ManipulationType.Set, Description = "Set CaptainJackSparrow's Item Slots to 4", ImageUrl = "Armor/Abas_Chain.png", MethodName = "SendCaptainJackSparrowItemSlotsMessage"  },
                    }
                },
                new ButtonTemplate
                {
